...
import Market from "./componentsdashboard/market";
import HistoryOffer from "./componentsdashboard/historyOffer";
import ActiveOffer from "./componentsdashboard/activeOffer";
import NewOffer from "./componentsdashboard/newOffer";
    ...
    <div>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/active-offer" element={<ActiveOffer/>} />
          <Route path="/history-offer" element={<HistoryOffer />} />
