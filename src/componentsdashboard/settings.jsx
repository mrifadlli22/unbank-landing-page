...
function Settings() {
    ...
    <div className="profile-card">
        <div className="profile-row">
            ...
            <div>
                ...
                <div className="profile-value">
                    NNM1YF 
                    <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/f0fa49d11b1b42a66719db23349e3127cf42c268bccba9854cf42fa56de3c4d8?placeholderIfAbsent=true&apiKey=e3ddd6dd58b748b09fc1391939743920" alt="Copy ID" className="copy-icon" />
                </div>
            </div>
        </div> 
        <div className="profile-row">
            ...
            <div className="profile-value">
                <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/7ff28497e74784051a96acc7aa8d8c04613769145a4ae2a16fa90aeac41b3da8?placeholderIfAbsent=true&apiKey=e3ddd6dd58b748b09fc1391939743920" alt="Status Icon" style={{ marginRight: '8px', width: '20px', height: '20px' }} />
        ...
        <div>
            ...
            <div className="profile-value">
                <img src="./Images/usd.png" alt="Status Icon" style={{ marginRight: '8px', width: '20px', height: '20px' }} />
                <span>English</span>
            </div>
            </div>
             <div>
    ...
    <div style={{marginTop:"25px"}} className="section">
            ...
            <p style={{marginTop:"15px"}}>In case of changes to your name, passport or other identity information changes, please contact Support.</p>
            </div>     
</div>
)}
                        {activeTab === 'support' && (
                        ...
                        <div>
                            <p>We're experiencing high volumes of inquiries, resulting in longer response times than we'd hoped for. We aim to reply to you within 2 working days.</p> 
                                ...
                                <div  style={{marginBottom:"25px"}} className="section-header-container">
                                    <div className="section-header">Active Transactions</div>
                                    <div className="divider2"></div>
                                    <button className="see-all-transactions-btn">View Archived</button>
                                </div>
                                <div className="support-card">
                                    <img style={{width:"245px"}} src="./Images/Image.png" alt="Contact Support" className="support-image" />
                                    <div className="support-content">
                                        <h3 style={{marginTop:"0px"}}>Contact Our Support</h3>
                       ...
                       <div className="security-alert">
                        <span>
                            <img style={{marginLeft:"5px"}} src='https://cdn.builder.io/api/v1/image/assets/TEMP/7ff28497e74784051a96acc7aa8d8c04613769145a4ae2a16fa90aeac41b3da8?placeholderIfAbsent=true&apiKey=e3ddd6dd58b748b09fc1391939743920' />
                        </span>
                        <div>
                            <p style={{fontWeight:"bold"}}>Currently your account is not secured by two-factor (2FA) authentication.</p> 
                            <p style={{fontSize:"15px", marginTop:"5px"}}>We strongly advise you to activate it. You can do this on this page.</p>
                        </div>
                        </div>
    ...
    <div style={{padding:"16px"}} class="security-cards">
        <div class="security-card">
            <p>Password <span class="note">(Please verify your phone number)</span></p>
            <p></p>
            <button class="verify-btn">Verify</button>
        </div>
        <div class="security-card">
            <p>Phone number <span class="note">(Please verify your phone number)</span></p>
            <button class="verify-btn">Verify</button>
        </div>
        <div class="security-card">
            <p>Email address <span class="note">(leideoviko@gmail.com)</span></p>
    ...
    <div style={{padding:"16px"}} class="security-cards">
        <div class="security-info">
            ...
            <div class="security-icon">
                <img style={{width:"130px", height:"130px"}} src="https://cdn.builder.io/api/v1/image/assets/TEMP/a17580f1256c55e1bc14792a448a27e0a41e5f06170349c6e7b7406257182948?placeholderIfAbsent=true&apiKey=e3ddd6dd58b748b09fc1391939743920" alt="2FA Icon" />
            </div>
            <p style={{marginTop:"0px"}} lass="security-description">2FA method can be enabled only after Your phone verification.</p>
            <button class="verification-btn">Phone Verification</button>
        </div>
    </div>
</div>
