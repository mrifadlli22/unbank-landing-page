  ...
  return (
    <div className="overview-box">
      <div className="overview-icon">
        <img
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/005ae3db4876b4ec59a2cdc6e9fb42efb39f1aea8bf81ffa16aa2dc92203d02e?placeholderIfAbsent=true&apiKey=e3ddd6dd58b748b09fc1391939743920"
...
function CurrencyCard({ amount, currency, flag, avatars }) {
  ...
  return (
    <div className="currency-card">
      ...
      <div className="currency-actions">{/* Action icons here */}</div>
  ...
  return (
    <div className="Digital-card">
      <div className="Digital-details">
        ...
        <div className="bank-description">{cardDig}</div>{" "}
        {/* Keterangan mata uang */}
      </div>
      <img src={bankCard} alt={NoRek} className="card-flag" />{" "}
      {/* Gambar bendera */}
    </div>
  );
}
                ...
                <div style={{ marginTop: "0px" }} className="currency-cards">
                  <CurrencyCard
                    ...
                    avatars={[
                      ...
                      {
                        src: "https://cdn.builder.io/api/v1/image/assets/TEMP/9006f4ffc40aa5929124465b5d2770f98124c3a291173ae6a518a0036b5aec45?placeholderIfAbsent=true&apiKey=e3ddd6dd58b748b09fc1391939743920",
                        alt: "Avatar 2",
                      },
                    ]}
                  />
                  ...
                  >
                    <div style={{ marginTop: "90px", textAlign: "center" }}>
                      ...
                      <p style={{ marginTop: "0px" }}>
                        More Currency Will be Added Soon...
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="section">
              ...
              <div className="containers">
                <div className="Digital-cards">
                  <Bank
                    Username="Leideovico"
                    NoRek="0000 0000 0000 0000 000"
                    bankCard="./Images/mandiri.png"
                    cardDig="Bank Mandiri"
                  />
                  <Bank
                    Username="Leideovico"
                    NoRek="0000 0000 0000 0000 000"
                    bankCard="./Images/bca.png"
                    cardDig="Bank BCA"
                  />
                  <div
                    className="add-card"
                ...
                <div className="no-transactions">
                  ...
                  <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/41b2b811ceff4d7de869164d340d415fbd6c5e25cc0c0698401bf035cfd17065?placeholderIfAbsent=true&apiKey=d04c07a3696b4df490c9872df5c4d2ba" alt="Icon" />
                    ...
                    <p>
                      ...
                      Once you start making transactions, they will be displayed
                      here.
                    </p>
                  </div>
                </div>
